...
<!-- ###The Mountains
Beautiful meadows, astonishing vistas all around Gulmarg, the top of Mt-Apharwat and the Gulmarg Cable Car; and amazing lakes atop the Himalayas. The Kashmiri region has enough beauty for every type of adventurer!
...
<div class="accordion pricing">
      ...
      <article class="ac-item" style="margin-top: -1px">
          ...
          <h5>During the day you will carry a day pack which should contain at least:</h5>
          <ul>
...
<!--<div class="row" data-item="post-item">
    <div class="col-sm-6 m-b-40">
        <div class="package-item-wrap">
            <div class="package-image">
                <span>
                    <img src="/user/themes/skigulmarg/images/packages/summer/gulmarg-trek-4-days.jpg" alt="Kashmir Trek Alpine Meadows">
                </span>
            </div>
                                        ...
                                        <div class="ac-content">
                                            ...
                                            <h5>Trip Summary</h5>
                                              <ul>
                                                ...
                                                <li>Difficulty: Medium at highest point. Easy throughout most of the trip</li>
                                                <li>5 total days for the trip</li>
    ...
    <div class="col-sm-6 m-b-40">
        <div class="package-item-wrap">
            <div class="package-image">
                <span>
                    <img src="/user/themes/skigulmarg/images/packages/summer/gulmarg-trek-6-days.jpg" alt="Hiking in Kashmir Alpine Meadows">
                </span>
            </div>
            <div class="package-description">
                <span>Easy Trek | Families & Beginners</span>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Gulmarg Trek - Alpine Meadows (6 Days) | Kashmir Trek Alpine Meadows</h4>
                            </div>
                            <div class="modal-body">
                                            ...
                                            <div class="ac-content">
                                                ...
                                                <h5>Trip Summary</h5>
                                                  <ul>
                                                    <li>Top height: 4000m at the Frozen Lake</li>
                                                    <li>Difficulty: Medium at highest point. Easy throughout most of the trip</li>
                                                    <li>6 total days for the trip</li>
                                                    <li>4 trekking days</li>
                                                    <li>Best Booked from April to October (good weather, not so cold)</li>
                                                  </ul>
                                                </div>
                                                ...
                                                <h5>Trip Itinerary</h5>
                                                  <ul>
                                                    ...
                                                    <b><u>Option 1:</u></b> Hike up to the Alpather Frozen lake. 4-5 hour trek. Altitude of 4000m. Climb down to the campsite from the night before. Can be quite challenging at first.<br>
                                                    <br>
                                                    <b><u>Option 2:</u></b> Recommended for beginners and Family with children. Hike up to Phase 1 of the <a href="https://gulmarggondola.com/about_gondola.php" target="_ blank">Gondola</a>. Ride to mount Apharwat. 2 hour trek to the frozen lake. Shorter climb down to the campsite and the kids can even ride a pony if they are too tired.</p>
                                                    </li>
                                                    <li><p><strong>Day 4</strong><br>
                                                    ...
                                                    Drive back to Srinagar and spend the night at a traditional Houseboat in <a href="http://www.walkthroughindia.com/offbeat/top-8-houseboat-destinations-incredible-india/">Dal Lake</a>.</p>
                                                    </li>
...
<!-- <div class="row" data-item="post-item">
    <div class="col-sm-6 m-b-40">
        <div class="package-item-wrap">
            <div class="package-image">
                <span>
                   <img src="/user/themes/skigulmarg/images/packages/summer/kashmir-trek-11-days.jpg" alt="Himalayan Great Lakes Trek">
                 </span>
            </div>
            <div class="package-description">
            <span>Easy Trek | Families & Beginners</span>
            <h3>Great Lakes Trek - Himalayan Mt. Range (11 Days)</h3>
            <div class="package-price">
                from <span>$1508 CAD</span> per person <br>(Min: 10 Nights / 11 Days)
            </div>
            <p>
            Our great lakes trek  is not for the faint of heart. It offers the greatest views and the most challenges as it consists of 11 days of trekking up and down the Kashmiri mountain, visiting the best places in Jammu and Kashmir, seeing waterfalls, lakes, forests and snow covered peaks, including the world famous Satsar Lake; a beautiful series of 7 interconnected lakes in a cascade formation. Ending with a relaxing tour of the floating market in <a href="http://www.walkthroughindia.com/offbeat/top-8-houseboat-destinations-incredible-india/" target="_ blank">Dal Lake</a>.<br>

            <u><b>The high altitude and demanding nature of the trip makes it unsuitable for children. If you wish to go trekking with children please consider our other packages.</b></u>
            </p>
            <button
                id="Himalayan-Great-Lakes-Trek-11d"
                class="btn btn-rounded btn-outline"
                type="button"
                data-target="#modal-checkfront-3"
                data-toggle="modal"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Great Lakes Trek - Himalayan Mt. Range (11 Days) | Hiking the Himalayas Great Lakes</h4>
                        </div>
                        <div class="modal-body">
                            <div id="CHECKFRONT_WIDGET_03">
                                <p class="searching-availability">
                                ...
                                <div class="accordion pricing">
                                        ...
                                        <div class="ac-content">
                                            <div class="table-container">
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>For 1-3 Travelers</td>
                                                            <td>$3368 CAD per person</td>

                                                        </tr>
                                                        <tr>
                                                            <td>For 4-5 travelers</td>
                                                            <td>$1838 CAD per person</td>

                                                        </tr>
                                                        <tr>
                                                            <td>For 6-7 travelers</td>
                                                            <td>$1808 CAD per person</td>

                                                        </tr>
                                                        <tr>
                                                            <td>For 8-9 travelers</td>
                                                            <td>$1538 CAD per person</td>

                                                        </tr>
                                                        <tr>
                                                            <td>For 10 travelers</td>
                                                            <td>$1508 CAD per person</td>
                                    ...
                                    <article class="ac-item" style="margin-top: -1px">
                                        ...
                                        <div class="ac-content">
                                            ...
                                            <ul>
                                            <li>10 nights of accommodation at the camping sites. Twin sharing camping. And at a deluxe  Houseboat at Dal lake</li>
                                            <li>Shikara ride on Dal Lake</li>
                                            <li>Pick up and drop off at the airport</li>
                                            <li>Horses to carry most equipment. You only need to carry the day pack as described in the “Gear Needed” tab</li>
                                            <li>Camping equipment, mattresses, transportation for personal equipment from camp to camp, meal preparation equipment and tents</li>
                                    ...
                                    <article class="ac-item" style="margin-top: -1px">
                                        ...
                                        <div class="ac-content">
                                            ...
                                            <h5>Trip Summary</h5>
                                              <ul>
                                                <li>Top height: 3710m at the Vishansar Lake</li>
                                                <li>Difficulty: Moderate challenge throughout. Recommended for adult, experienced trekkers</li>
                                                <li>11 total days for your trip</li>
                                                <li>8 trekking days</li>
                                                <li>Best Booked from July to September (good weather, not so cold, best view of the lakes)</li>
                                              </ul>
                                            </div>
                                            ...
                                            <h5>Trip Itinerary</h5>
                                              <ul>
                                                ...
                                                <li><p><strong>Day 6</strong><br>
                                                Trek to <a href="https://vagabondimages.in/2018/01/27/a-tale-of-seven-lakes-gadsar-to-satsar/" target="_ blank">Satsar lake</a>. Beautiful lakes in cascading formation- 6 hour trek at 3636m.</p>
                                                </li>
                                                <li><p><strong>Day 7</strong><br>
                                                Trek to <a href="https://en.wikipedia.org/wiki/Gangabal_Lake" target="_ blank">Gangabal Twin Lakes</a>. 6 hour trek at 3458m </p>
                                                </li>
                                                ...
                                                <li><p><strong>Day 9</strong><br>
                                                Descend to Naranag, 6 hour trip at 2258m. Drive back to Srinagar and Rest at a traditional Houseboat on <a href="http://www.walkthroughindia.com/offbeat/top-8-houseboat-destinations-incredible-india/" target="_ blank">Dal Lake</a>. </p>
                                                </li>
                                                <li><p><strong>Day 10</strong><br>
                                                Day for sightseeing or relax. Enjoy a Shikara ride to the floating market, stroll around the lake and walk to the Mughal Gardens. OR just spend the day sleeping and sipping tea, your feet will surely appreciate the rest. </p>
                                                </li>
...
<!--
###The Village
The region is open to exploration as soon as the winter is over. Families can enjoy exciting trips on the meadows, enjoying fresh breezes and visiting important landmarks. Thrill seekers can embark on a unforgattavle trip to see the beautiful lakes atop the Himalayas. Those who just want relaxation can spend a spa day at the Khyber or a night at a deluxe Houseboat on Dal Lake.
